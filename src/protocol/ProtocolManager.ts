...
import CrawlBloomBergAsk from './trending/CrawlBloomBergAsk';
import { CrawlBloomBergAskRegistration } from './trending/CrawlBloomBergAsk';
import CrawlBloomBergAnswer from './trending/CrawlBloomBergAnswer';
import { CrawlBloomBergAnswerRegistration } from './trending/CrawlBloomBergAnswer';
import CrawlReutersAsk from './trending/CrawlReutersAsk';
import { CrawlReutersAskRegistration } from './trending/CrawlReutersAsk';
import CrawlReutersAnswer from './trending/CrawlReutersAnswer';
import { CrawlReutersAnswerRegistration } from './trending/CrawlReutersAnswer';
...
protocols.set(422, new CrawlBloomBergAskRegistration());
protocolIdMap.set(CrawlBloomBergAsk, 422);
protocols.set(423, new CrawlBloomBergAnswerRegistration());
protocolIdMap.set(CrawlBloomBergAnswer, 423);
protocols.set(424, new CrawlReutersAskRegistration());
protocolIdMap.set(CrawlReutersAsk, 424);
protocols.set(425, new CrawlReutersAnswerRegistration());
protocolIdMap.set(CrawlReutersAnswer, 425);
protocols.set(430, new TrendingRequestRegistration());
protocolIdMap.set(TrendingRequest, 430);
protocols.set(431, new TrendingResponseRegistration());
protocolIdMap.set(TrendingResponse, 431);
protocols.set(432, new TrendingRegistration());
protocolIdMap.set(Trending, 432);
